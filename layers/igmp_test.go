...
var igmpv2MembershipReportPacketWithMaxRespTime = []byte{
	0x01, 0x00, 0x5e, 0x7f, 0xff, 0xfd, 0x00, 0x15, 0x58, 0xdc, 0xd9, 0xf6, 0x08, 0x00, 0x46, 0x00,
	0x00, 0x20, 0x79, 0xf0, 0x00, 0x00, 0x01, 0x02, 0xab, 0x47, 0x0a, 0x3c, 0x05, 0x67, 0xef, 0xff,
	0xff, 0xfd, 0x94, 0x04, 0x00, 0x00, 0x16, 0xa8, 0xfa, 0x01, 0xef, 0xff, 0xff, 0xfd, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
}
...
// decode a Packet(want) from bytes
// serialize the packet to buffer
// decode another Packet(got) from buffer.Bytes, want and got should DeepEqual
func TestIGMPv2MembershipReportSerialize(t *testing.T) {
	...
	serialize = append(serialize, p.Layer(LayerTypeIPv4).(*IPv4))
	serialize = append(serialize, p.Layer(LayerTypeIGMP).(*IGMPv1or2))
